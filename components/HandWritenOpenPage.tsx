// components/HandWritenOpenPage.tsx
"use client";
...
export default function HandWritenOpenPage({
  title = "Hand Written",
  subtitle = "Optional subtitle",
}: HandWrittenTitleProps) {
  // ✅ 关键修复：在 ease 后面添加 as any，绕过 TS 类型限制
  const draw = {
    ...
    visible: {
      ...
      opacity: 1,
      transition: {
        pathLength: { duration: 2.5, ease: "easeInOut" as any },   // ← 这里添加 as any
